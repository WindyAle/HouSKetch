...
def load_furniture_data(grid_size):
    ...
    FURNITURE_LIST = [
        ...
        },
        {
            "name": "침대",
            "size": (2, 2),
            "image_path": "assets/bed.png", # (오류 수정)
            "image": load_scaled_image("assets/bed.png", (2, 2), grid_size), # (오류 수정)
            "color": (50, 50, 120)
        },
        {
            "name": "식물",
            "size": (1, 1),
            "image_path": "assets/plant.png", # (새 가구)
            "image": load_scaled_image("assets/plant.png", (1, 1), grid_size),
            "color": (30, 100, 30)
        }
    ]
